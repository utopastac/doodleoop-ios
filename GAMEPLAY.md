...
3. Host enters a **category** and starts when there are at least 2 players

## Round

| Turn parity | Action |
|-------------|--------|
| Even (`0, 2, …`) | Draw from the prompt in front of you (category or last guess) |
| Odd (`1, 3, …`) | Guess what the drawing in front of you depicts |

After everyone submits, each pad moves one seat to the left.
